...
class ComplaintProvider extends ChangeNotifier {
  ...
  Future<void> updateNearbyComplaints() async {
    ...
    nearbyComplaints = complaints.where((c){
  ...
  void startRealtime(){
    ...
    /// new complaints
    RealtimeService.onComplaint = (data){

      final exists = complaints.any(
        (c)=> c['complaint_id'] == data['complaint_id']
      );
